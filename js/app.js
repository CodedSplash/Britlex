    ...
    function windowLoad() {
        ...
        function digitsCounterAnimate(digitsCounter) {
            ...
            const step = timestamp => {
                ...
                const progress = Math.min((timestamp - startTimestampt) / duration, 1);
        ...
        let sections = document.querySelectorAll(".advantages-about");
        if (sections.length) sections.forEach((sections => {
